...
public class ModuleController {
    ...
    public ModuleDto addModule(@Validated @RequestBody ModuleDto moduleDto) {
        return moduleService.addModule(moduleDto);
    }

    @PutMapping
    public ModuleDto updateModule(@Validated @RequestBody ModuleDto moduleDto) {
        return moduleService.updateModule(moduleDto);
    }

    @DeleteMapping("/{moduleId}")
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void deleteModule(@Validated @PathVariable("moduleId") Long moduleId) {
